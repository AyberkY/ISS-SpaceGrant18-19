...
def cursesTest(stdscr):
    ...
    while True:
        try:
            ...
            stdscr.addstr(7,15,str(random.randint(0,10)))
            stdscr.addstr(8,15,str(random.randint(0,10)))

            stdscr.addstr(10,15,str(random.randint(0,10)))
            stdscr.addstr(11,15,str(random.randint(0,10)))
            stdscr.addstr(12,15,str(random.randint(0,10)))

            stdscr.addstr(0,45,str(random.randint(0,10)))
            stdscr.addstr(1,45,str(random.randint(0,10)))
            stdscr.addstr(2,45,str(random.randint(0,10)))

            stdscr.addstr(4,45,str(random.randint(0,10)))
            stdscr.addstr(5,45,str(random.randint(0,10)))
            stdscr.addstr(6,45,str(random.randint(0,10)))
            stdscr.addstr(7,45,str(random.randint(0,10)))
            stdscr.addstr(8,45,str(random.randint(0,10)))
            stdscr.addstr(9,45,str(random.randint(0,10)))
