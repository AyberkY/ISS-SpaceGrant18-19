...
plt.plot(telemDict1['time'], processData(telemDict1['height'], scale=(1/0.3048)), color='orange', label="TM Altitude")
plt.plot(dataDict1['unix_timestamp'], processData(baroSmoother(dataDict1['baro_altitude']), scale=(1/0.3048), offset=-205.375), color='b', label="Non-Commercial Altitude")
...
plt.plot(telemDict2['time'], processData(telemDict2['height'], scale=(1/0.3048)), color='orange', label="TM Altitude")
